...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal bool VerificaDigito(string CPF)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", CPF));

            DataSet ds = base.Consultar("FI_SP_VerificaDigitoCpf", parametros);
        ...
        internal List<Beneficiario> listaBeneficiario(long IdCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            parametros.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", IdCliente));
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    DML.Beneficiario Reg = new DML.Beneficiario();

                    Reg.Nome = drSource.Field<string>("NOME");
                    Reg.Id = drSource.Field<long>("Id");
                    Reg.CPF = drSource.Field<string>("CPF");
        ...
        /// </summary>
        /// <param name="cliente">Objeto de cliente</param>
        internal void ExcluirBeneficoario(long Id)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
        ...
        /// </summary>
        /// <param name="cliente">Objeto de cliente</param>
        internal void AlterarBeneficiario(long Id, string NOME)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
